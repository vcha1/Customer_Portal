...
public class RegistrationController {
    ...
    public GenericResponse savePassword(final Locale locale, @Valid PasswordDto passwordDto) {
        ...
        return new GenericResponse(messages.getMessage("message.setPasswordSuc", null, locale));
    }
    ...
    private SimpleMailMessage constructSetPasswordEmail(final String contextPath, final Locale locale, final String token, final User user) {
        final String url = contextPath + "/user/changePassword?id=" + user.getId() + "&token=" + token;
        final String message = messages.getMessage("message.choosePassword", null, locale);
        return constructEmail("1st Light Energy: Choose your password", message + " \r\n" + url, user);
    }
